...
const PricingSection = ({ className = '' }) => {
  ...
  return (
    <section
      id="pricing"
      ref={sectionRef}
      className={`relative w-screen max-w-full overflow-hidden bg-[#050709] px-3 py-16 font-mono text-white sm:px-5 sm:py-20 lg:py-24 ${className}`}
    >
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        >
          <g fill="none" stroke="#00E676" strokeWidth="1.2">
      ...
      <div className="relative mx-auto grid max-w-6xl gap-4 md:grid-cols-3">
        {plans.map((plan, index) => (
          <article
            ...
            className={`relative flex min-h-[360px] flex-col overflow-hidden border border-white/70 ${plan.tint} p-4 ring-1 ring-white/10 shadow-[8px_8px_0_rgba(0,230,118,0.12)] sm:p-5`}
          >
            ...
            <div className="border-b border-white/20 pb-4 pt-2">
              ...
              <p className="mt-3 max-w-[24rem] font-bold uppercase leading-snug text-xs text-white/60">{plan.note}</p>
            </div>
            ...
            <div className="py-7">
              ...
              <div className="mt-2 font-black uppercase tracking-[0.12em] text-[10px] text-white/45 sm:text-xs">
                {plan.cadence}
              </div>
            </div>

            <ul className="mt-auto grid gap-2 border-t border-white/20 pt-4">
            ...
            <button className="mt-5 border border-[#00E676] bg-[#00E676] px-3 py-3 text-left font-black uppercase italic tracking-[0.12em] text-black transition-colors hover:bg-white">
              Select plan
            </button>
          </article>
        ))}
