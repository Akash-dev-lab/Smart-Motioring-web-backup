...
const HowItWorksStep = React.memo(React.forwardRef(({ step, className = '', style }, ref) => {
      ...
      >
        ...
        <div 
          style={{
            ...
            right: 0,
            height: '1px',
            background: 'linear-gradient(90deg, transparent, rgba(117, 255, 158, 0.5), rgba(208, 188, 255, 0.5), transparent)',
            opacity: 0.5,
          }}
        />
        ...
        <div className="flex justify-between items-center mb-8 border-b border-white/5 pb-4">
          <div className="font-['JetBrains_Mono'] text-[13px] text-[#bacbb9] tracking-wider flex items-center gap-2 opacity-80">
            <span className="text-[#75ff9e] font-bold">{step.label}</span>
            <span className="text-white/20">/</span> 
            STEP {step.label}
          </div>
          <div className="inline-flex items-center gap-2 px-2.5 py-1 bg-[#0C0E12] border border-white/10 rounded font-['JetBrains_Mono'] text-[10px] text-[#bacbb9] uppercase tracking-wider">
            <div className="w-1.5 h-1.5 rounded-full bg-[#75ff9e] animate-[pulse_1.5s_cubic-bezier(0.4,0,0.6,1)_infinite] shadow-[0_0_5px_#75ff9e]"></div>
            {step.metric}
          </div>
        </div>
        ...
        <div className="mb-10 text-center">
          <h3 className="font-['Geist'] text-[32px] leading-tight font-semibold text-white mb-3 uppercase">{step.title}</h3>
        ...
        <div className="bg-[#141414] border border-white/5 rounded-lg p-6 relative overflow-hidden">
          ...
          <div className="flex justify-between items-center mb-8 border-b border-white/10 pb-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="font-['JetBrains_Mono'] text-[11px] text-[#e2e2e6]">INCIDENT_PIPELINE</span>
                <span className="font-['JetBrains_Mono'] text-[9px] text-[#ffb4ab] flex items-center gap-1">
                  <span className="w-1 h-1 rounded-full bg-[#ffb4ab]"></span> LIVE
                </span>
              </div>
            </div>
            <span className="font-['JetBrains_Mono'] text-[10px] text-[#bacbb9]">REGION: US-EAST-1</span>
          </div>
          ...
          <div className="relative py-6">
            ...
            <div className="absolute top-1/2 left-0 w-full h-[1px] -translate-y-1/2 overflow-hidden">
              <div 
                style={{
                  position: 'absolute',
                  top: 0,
                  ...
                  width: '50%',
                  height: '100%',
                  background: 'linear-gradient(90deg, transparent, rgba(255, 180, 171, 0.8), transparent)',
            ...
            <div className="flex justify-between items-center relative z-10">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <div className="text-center">
                  <div className="font-['JetBrains_Mono'] text-[10px] text-[#e2e2e6]">DB_TIMEOUT</div>
                  <div className="font-['JetBrains_Mono'] text-[9px] text-[#ffb4ab]">SEV: HIGH</div>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center gap-2 relative">
                <div className="w-28 py-2.5 px-3 bg-[#0C0E12] border border-[#A78BFA]/30 rounded-lg flex flex-col items-center justify-center gap-1.5 relative">
                  ...
                  <svg className="w-5 h-5 text-[#A78BFA]" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M3 12v3c0 1.657 3.134 3 7 3s7-1.343 7-3v-3c0 1.657-3.134 3-7 3s-7-1.343-7-3z" />
                    <path d="M3 7v3c0 1.657 3.134 3 7 3s7-1.343 7-3V7c0 1.657-3.134 3-7 3S3 8.657 3 7z" />
                    <path d="M17 5c0 1.657-3.134 3-7 3S3 6.657 3 5s3.134-3 7-3 7 1.343 7 3z" />
                  </svg>
                  <span className="font-['JetBrains_Mono'] text-[9px] text-[#e2e2e6] tracking-widest text-center leading-tight">INCIDENT<br/>COMMAND</span>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex items-center gap-2 bg-[#0C0E12] border border-white/10 px-2.5 py-1.5 rounded-md">
                  <svg className="w-3.5 h-3.5 text-[#bacbb9]" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M2 5a2 2 0 012-2h7a2 2 0 012 2v4a2 2 0 01-2 2H9l-3 3v-3H4a2 2 0 01-2-2V5z" />
                    <path d="M15 7v2a4 4 0 01-4 4H9.828l-1.766 1.767c.28.149.599.233.938.233h2l3 3v-3h2a2 2 0 002-2V9a2 2 0 00-2-2h-1z" />
                  </svg>
                  <span className="font-['JetBrains_Mono'] text-[9px] text-[#e2e2e6]">#alerts-sev1</span>
                ...
                <div className="flex items-center gap-2 bg-[#0C0E12] border-l-2 border-[#ffb4ab] px-2.5 py-1.5 rounded-md relative overflow-hidden">
                  ...
                  <svg className="w-3.5 h-3.5 text-[#ffb4ab] relative z-10" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                  </svg>
                  <span className="font-['JetBrains_Mono'] text-[9px] text-[#e2e2e6] relative z-10">PagerDuty</span>
                ...
                <div className="flex items-center gap-2 bg-[#0C0E12] border border-white/10 px-2.5 py-1.5 rounded-md">
                  ...
                  <span className="font-['JetBrains_Mono'] text-[9px] text-[#e2e2e6]">on-call@sys</span>
                  <span className="w-1.5 h-1.5 rounded-full bg-[#75ff9e] ml-auto"></span>
                </div>
              </div>
            </div>
          ...
          <div className="mt-6 border-t border-white/10 pt-3 flex justify-between">
            <span className="font-['JetBrains_Mono'] text-[9px] text-[#bacbb9]">CORRELATION_ID: 9a8b-4c2d-11ef</span>
            <span className="font-['JetBrains_Mono'] text-[9px] text-[#bacbb9]">T+ 0.045s</span>
          </div>
        </div>
    ...
    return (
      ...
      >
        ...
        <div className="bg-[#141414] border border-white/5 rounded-lg p-6 relative overflow-hidden flex flex-col gap-4">
          ...
          <div className="rounded border border-[#75ff9e]/20 bg-[#75ff9e]/5 p-4 relative overflow-hidden">
            ...
            <div className="flex justify-between items-start mb-2">
              <div className="flex items-center gap-2">
                ...
                <span className="font-['JetBrains_Mono'] text-[10px] text-[#75ff9e] uppercase tracking-wider">Root Cause Analysis</span>
              </div>
              <span className="font-['JetBrains_Mono'] text-[9px] bg-[#75ff9e] text-black px-1.5 py-0.5 rounded font-bold tracking-wide">FIX</span>
            </div>
            <p className="font-['Geist'] text-[12px] text-[#bacbb9] leading-relaxed mb-3">
              Memory leak detected in <code className="bg-black/30 px-1 py-0.5 rounded text-[#75ff9e] font-['JetBrains_Mono']">user-auth-service</code> pod. Garbage collection cycles failing to clear heap due to lingering WebSocket connections.
            </p>
            <div className="flex items-center gap-2">
              <button className="bg-[#0C0E12] hover:bg-[#282a2d] border border-white/10 px-2.5 py-1.5 rounded text-[10px] font-['JetBrains_Mono'] transition-colors flex items-center gap-1.5 text-[#e2e2e6]">
          ...
          {/* Log Snippet */}
          <div className="rounded border border-white/10 bg-black p-3 font-['JetBrains_Mono'] text-[10px] overflow-hidden">
            ...
            <div className="space-y-1 text-[#bacbb9] opacity-80">
              ...
              <div className="flex gap-2 bg-[#75ff9e]/10 border-l-2 border-[#75ff9e] pl-2 py-1 -ml-2">
                ...
                <span className="text-[#e2e2e6]">Incident auto-resolved by remediation rule #42.</span>
              </div>
            </div>
          </div>
        </div>
  ...
  // Default visual for other cards
  return (
    <article
      ref={ref}
      className={`bg-black rounded-xl p-8 ${className}`}
    ...
    >
      ...
      {/* Visual Workflow */}
      <div className="bg-[#141414] border border-white/5 rounded-lg p-6 relative overflow-hidden">
        {/* Pure black background - no grid */}
        
        <div className="relative z-10 flex flex-col items-center">
          {/* Top Node */}
          <div className="bg-black border border-white/10 rounded px-4 py-2 font-['JetBrains_Mono'] text-[13px] text-[#e2e2e6] flex items-center gap-2 shadow-lg">
            <svg className="w-4 h-4  text-[#75ff9e]" fill="currentColor" viewBox="0 0 20 20">
          ...
          >
            <div 
              style={{
                ...
                width: '100%',
                height: '30%',
                background: 'linear-gradient(to bottom, transparent, #75ff9e, transparent)',
          ...
          {/* Engine Node */}
          <div className="bg-[#282a2d] border border-[#75ff9e]/20 rounded px-4 py-2 font-['JetBrains_Mono'] text-[13px] text-[#75ff9e] font-medium flex items-center gap-2 shadow-[0_0_15px_rgba(117,255,158,0.1)]">
            <Icon className="w-4 h-4" />
            MONITORING ENGINE
          </div>

          {/* Flow Split */}
          <div className="relative w-full max-w-[300px] h-10 mt-1 flex justify-center">
            <div className="absolute top-0 w-0.5 h-4 bg-white/10"></div>
            <div className="absolute top-4 w-56 h-[1px] bg-white/10"></div>
            <div className="absolute top-4 left-10 w-[1px] h-6 bg-white/10 overflow-hidden">
              <div 
                style={{
                  position: 'absolute',
                  top: 0,
                  ...
                  width: '100%',
                  height: '100%',
                  background: 'linear-gradient(to bottom, transparent, rgba(117, 255, 158, 0.5), transparent)',
                  animation: 'signal 2s linear infinite 0.2s',
                }}
              />
            </div>
            <div className="absolute top-4 left-1/2 w-[1px] h-6 bg-white/10 -translate-x-1/2 overflow-hidden">
              <div 
                style={{
                  position: 'absolute',
                  top: 0,
            ...
            <div className="absolute top-4 right-9 w-[1px] h-6 bg-white/10 overflow-hidden">
              <div 
                style={{
                  position: 'absolute',
                  top: 0,
          ...
          <div className="flex justify-between w-full max-w-[320px] gap-6">
            <div className="flex-1 bg-[#000000] border border-white/5 rounded px-2 py-1.5 flex flex-col items-center gap-1">
              <span className="font-['JetBrains_Mono'] text-[10px] text-[#bacbb9]">US-EAST</span>
              <div className="w-1.5 h-1.5 rounded-full bg-[#75ff9e] shadow-[0_0_4px_#75ff9e]"></div>
            </div>
            <div className="flex-1 bg-[#000000] border border-white/5 rounded px-2 py-1.5 flex flex-col items-center gap-1">
              <span className="font-['JetBrains_Mono'] text-[10px] text-[#bacbb9]">EU-WEST</span>
              <div className="w-1.5 h-1.5 rounded-full bg-[#75ff9e] shadow-[0_0_4px_#75ff9e]"></div>
            </div>
            <div className="flex-1 bg-[#000000] border border-white/5 rounded px-2 py-1.5 flex flex-col items-center gap-1">
              <span className="font-['JetBrains_Mono'] text-[10px] text-[#bacbb9]">AP-SOUTH</span>
              <div className="w-1.5 h-1.5 rounded-full bg-[#75ff9e] shadow-[0_0_4px_#75ff9e]"></div>
            </div>
          </div>
        </div>
